	...
	public static function get_default_resources() {
		return array(
			array(
				...
				'name'                 => 'Luxury Speedboat Alesta Raptor',
			...
			array(
				...
				'sort_order'           => 20,
				'color'                => '#1f6bff',
				'notes'                => 'High-end RIB suitable for rentals, excursions, and transfers.',
			),
			array(
				'resource_type'        => 'boat',
				'category'             => 'speedboat',
				...
				'sort_order'           => 30,
				'color'                => '#1f6bff',
				'notes'                => 'Top-tier Zar performance for premium day routes.',
			),
			array(
				'resource_type'        => 'boat',
				'category'             => 'speedboat',
				...
				'sort_order'           => 40,
				'color'                => '#1f6bff',
				'notes'                => 'Comfortable smaller RIB with stronger engine.',
			),
			array(
				'resource_type'        => 'boat',
				'category'             => 'speedboat',
			...
			array(
				...
				'sort_order'           => 60,
				'color'                => '#1f6bff',
				'notes'                => 'Comfortable self-drive RIB for Hvar day routes.',
			),
			array(
				'resource_type'        => 'boat',
				'category'             => 'speedboat',
				'name'                 => 'Scar Next 150HP',
				...
				'sort_order'           => 70,
				'color'                => '#1f6bff',
				'notes'                => 'Sporty open boat, ideal for smaller groups.',
			),
			array(
				'resource_type'        => 'boat',
				'category'             => 'speedboat',
			...
			array(
				...
				'sort_order'           => 90,
				'color'                => '#d63131',
				'notes'                => 'Fuel included. Comfortable self-drive cruising around Pakleni.',
			),
			array(
				'resource_type'        => 'boat',
				'category'             => 'boat',
				...
				'sort_order'           => 100,
				'color'                => '#d63131',
				'notes'                => 'Lighter self-drive option for short day cruising.',
			),
		);
	}
}
