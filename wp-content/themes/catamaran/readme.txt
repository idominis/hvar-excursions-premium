...
Please install and activate it before starting to use the theme Catamaran.
...
Theme documentation is available on https://catamaran.axiomthemes.com/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Catamaran is Fontello.
