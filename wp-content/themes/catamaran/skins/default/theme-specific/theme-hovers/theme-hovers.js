...
jQuery( document ).on(
	'action.init_hidden_elements', function(e, cont) {
		...
		if (CATAMARAN_STORAGE['button_hover'] && CATAMARAN_STORAGE['button_hover'] != 'default') {
			jQuery(
				// Tag 'button'
				...
				// Theme tabs
				+ '.catamaran_tabs .catamaran_tabs_titles li a:not([class*="sc_button_hover_"]),'
				// More link
			...
			).addClass( 'sc_button_hover_just_init sc_button_hover_' + CATAMARAN_STORAGE['button_hover'] );

			// Add button's hover class if not based on :before or :after elements (like 'sc_button_hover_arrow')
			if (CATAMARAN_STORAGE['button_hover'] != 'arrow') {
				jQuery(
					// Form buttons
			...
			jQuery(
				...
				// Theme tabs
				+ '.catamaran_tabs .catamaran_tabs_titles li a:not([class*="sc_button_hover_style_"]),'
				// Tag cloud
			...
			).removeClass( 'sc_button_hover_' + CATAMARAN_STORAGE['button_hover'] );
