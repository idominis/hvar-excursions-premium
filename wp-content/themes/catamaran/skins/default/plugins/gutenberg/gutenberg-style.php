...
if ( ! function_exists( 'catamaran_gutenberg_get_css' ) ) {
	add_filter( 'catamaran_filter_get_css', 'catamaran_gutenberg_get_css', 10, 2 );
	function catamaran_gutenberg_get_css( $css, $args ) {
