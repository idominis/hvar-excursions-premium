...
if ( ! function_exists( 'catamaran_woocommerce_get_css' ) ) {
	add_filter( 'catamaran_filter_get_css', 'catamaran_woocommerce_get_css', 10, 2 );
	function catamaran_woocommerce_get_css( $css, $args ) {
...
$fdir = catamaran_get_file_dir( 'plugins/woocommerce/woocommerce-skin.php' );
if ( ! empty( $fdir ) ) {
	require_once $fdir;
}
