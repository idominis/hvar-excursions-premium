...
<div class="sc_events_item sc_item_container post_container">
    ...
    <div class="sc_events_item_info"><?php
        if ($cost !== '') { ?>
            <div class="sc_events_item_price<?php echo esc_attr('Free' == $cost ? ' free_price' : '')?>"><span class="sc_events_item_price_text"><?php catamaran_show_layout($cost);?></span></div><?php
        } ?>
