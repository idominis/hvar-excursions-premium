...
<div class="sc_events_item sc_item_container post_container">
	...
	<div class="sc_events_item_info">
        ...
        <div class="sc_events_item_date_start">
            <div class="sc_events_item_date_day"><?php catamaran_show_layout( date_i18n('d', strtotime($dt)) )?></div><div class="sc_events_item_date_month"><?php catamaran_show_layout( date_i18n('M, Y', strtotime($dt)) )?></div>
        </div>
                ...
                trx_addons_get_template_part('templates/tpl.featured.php',
                    ...
                    apply_filters('trx_addons_filter_args_featured', array(
                        ...
                        'thumb_size' => apply_filters('trx_addons_filter_thumb_size',
                            catamaran_get_thumb_size('square'),
    ...
    if ($cost !== '') { ?>
        <div class="sc_events_item_price<?php echo esc_attr('Free' == $cost ? ' free_price' : '')?>"><?php catamaran_show_layout($cost);?></div><?php
    } ?>
