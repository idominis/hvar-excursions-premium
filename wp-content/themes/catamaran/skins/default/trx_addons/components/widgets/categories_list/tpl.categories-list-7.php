				...
				?><div class="<?php echo esc_attr(trx_addons_get_column_class(1, $columns, $columns_tablet, $columns_mobile)); ?>"><?php
					...
					<div class="categories_list_item">
						...
						$src = empty($image)
							...
							: trx_addons_add_thumb_size($image, catamaran_get_thumb_size('full'));
						$attr = trx_addons_getimagesize($src);
						?>
							<div class="post_thumb bg_in <?php echo catamaran_add_inline_css_class('background-image: url('. esc_url($src).');'); ?>"></div>
						</div><?php
						?>
