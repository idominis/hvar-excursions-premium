...
while ( have_posts() ) { the_post();
	...
	$catamaran_cpt_team_article_info_output = '';
	ob_start();
		...
		<div class="team_member_details">
			...
			if ( $need_info ) {
				...
				<div class="team_member_brief_info">
					<h3 class="section_title team_member_brief_info_title"><?php esc_html_e('Biography', 'catamaran'); ?></h3>
	...
	$catamaran_cpt_team_article_info_output = ob_get_contents();
	ob_end_clean();

	do_action('trx_addons_action_after_article', 'team.single', $catamaran_cpt_team_article_info_output);
