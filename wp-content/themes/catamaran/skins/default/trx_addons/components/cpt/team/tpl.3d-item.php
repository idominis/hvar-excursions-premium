...
?>>
	...
	trx_addons_get_template_part('templates/tpl.featured.php',
								...
								apply_filters( 'trx_addons_filter_args_featured', array(
										...
										'thumb_bg' => true,
										'hover' => 'info_anim',
										'thumb_size' => catamaran_get_thumb_size('full'),
...
if ( !function_exists( 'catamaran_sc_icons_merge_scripts' ) ) {
	add_action("trx_addons_filter_merge_scripts", 'catamaran_sc_icons_merge_scripts');
	function catamaran_sc_icons_merge_scripts($list) {
