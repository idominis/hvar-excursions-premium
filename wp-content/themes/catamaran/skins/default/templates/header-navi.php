		...
		<div class="columns_wrap columns_fluid">
			<div class="sc_layouts_column sc_layouts_column_align_left sc_layouts_column_icons_position_left sc_layouts_column_fluid column-1_4">
				...
				<div class="sc_layouts_item">
					<?php
					// Main menu
					$catamaran_menu_main = catamaran_get_nav_menu( 'menu_main' );
					// Show any menu if no menu selected in the location 'menu_main'
					if ( catamaran_get_theme_setting( 'autoselect_menu' ) && empty( $catamaran_menu_main ) ) {
						$catamaran_menu_main = catamaran_get_nav_menu();
					}
					catamaran_show_layout(
						$catamaran_menu_main,
						'<nav class="menu_main_nav_area sc_layouts_menu sc_layouts_menu_default sc_layouts_hide_on_mobile"'
							. ( catamaran_is_on( catamaran_get_theme_option( 'seo_snippets' ) ) ? ' itemscope="itemscope" itemtype="' . esc_attr( catamaran_get_protocol( true ) ) . '//schema.org/SiteNavigationElement"' : '' )
							. '>',
						'</nav>'
					);
					// Mobile menu button
