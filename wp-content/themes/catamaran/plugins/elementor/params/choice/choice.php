 ...
 */
class Catamaran_Elementor_Control_Choice extends \Elementor\Base_Data_Control {
	...
	public function enqueue() {
		wp_enqueue_script( 'catamaran-elementor-choice-control', catamaran_get_file_url( 'plugins/elementor/params/choice/choice-control.js'), array('jquery'), null, true );
	}
						...
						_.each( data.options, function( params, slug ) {
							print( ( params.new_row !== undefined
									...
									+ '<span tabindex="0" class="catamaran_list_choice_item'
												+ ( ( slug == data.controlValue && '' !== data.controlValue ) || ( 'inherit' == slug && '' === data.controlValue ) ? ' catamaran_list_active' : '' )
												+ '"'
										+ ' data-choice="' + slug + '"'
